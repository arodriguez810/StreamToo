(function ($, window, document, undefined) {
        ...
        init: function () {
            ...
            if (storage && self.o.localStorage && getKeySettings) {
                ...
                for (var key in jsonSettings.widget) {
                    ...
                    var h2a = widgetId.children("header").children("h2"); //aqui
                    var article = widgetId.children("header").children("h2").parent().parent().parent();
                    var anchoxCantWidget = "";

                    if ($(article).hasClass("col-lg-12")) {
                        anchoxCantWidget = "auto";
                    }
                    else if ($(article).hasClass("col-lg-6")) {
                        anchoxCantWidget = "350px";
                    }
                    else if ($(article).hasClass("col-lg-3")) {
                        anchoxCantWidget = "85px";
                    }
                    else if ($(article).hasClass("col-lg-4")) {
                        anchoxCantWidget = "178px";
                    }

                    $(h2a).css("overflow", "hidden");
                    $(h2a).css("text-overflow", "ellipsis");
                    $(h2a).css("white-space", "nowrap");
                    $(h2a).css("width", "" + anchoxCantWidget + "");
                    $(h2a).addClass("ppaa");
                    //$(h2a).addClass("truncatetext");
                    $(h2a).attr("title", widgetId.children("header").children("h2").text());
                }
            }
            self.widget.each(function () {
                var tWidget = $(this);
                var thisHeader = $(this).children("header");
                thisHeader.attr("class", "btn-" + primaryColor);
                if (!thisHeader.parent().attr("role")) {
                    ...
                    if (self.o.customButton === true && tWidget.data("widget-custombutton") === undefined && self.customClass[0].length != 0) {
                        var customBtn = '<a href="javascript:void(0);" class="button-icon jarviswidget-custom-btn btn-' + secundaryColor + '"><i class="' + self.customClass[0] + '"></i></a>'
                    } else {
                        customBtn = "";
                    }
                    if (self.o.deleteButton === true && tWidget.data("widget-deletebutton") === undefined) {
                        var deleteBtn = '';
                        //var deleteBtn = '<a href="javascript:void(0);" class="button-icon jarviswidget-delete-btn btn-' + secundaryColor + '" rel="tooltip" title="Delete" data-placement="bottom"><i class="' + self.o.deleteClass + '"></i></a>'
                    } else {
                        deleteBtn = "";
                    }
                    ...
                    if (self.o.toggleButton === true && tWidget.data("widget-togglebutton") === undefined) {
                        ...
                        var toggleBtn = '<a href="#" class="button-icon jarviswidget-toggle-btn btn-' + secundaryColor + '" rel="tooltip" title="Collapse/Span" data-placement="bottom"><i class="' + toggleSettings + '"></i></a>'
                    } else {
                        toggleBtn = "";
                    }
                    if (self.o.refreshButton === true && tWidget.data("widget-refreshbutton") != false && tWidget.data("widget-load")) {
                        var refreshBtn = '<a href="#" class="button-icon jarviswidget-refresh-btn btn-' + secundaryColor + '" data-loading-text="&nbsp;&nbsp;Loading...&nbsp;" rel="tooltip" title="Refresh" data-placement="bottom"><i class="' + self.o.refreshButtonClass + '"></i></a>'
                    } else {
                        refreshBtn = ""
                    }
                    ...
                    tWidget.attr("role", "BaseDonWidget").children("div").attr("class", "well").attr("role", "content").prev("header").attr("role", "heading").children("div").attr("role", "menu")
                }
            });
        ...
        _clickEvents: function () {
            ...
            function heightFullscreen() {
                ...
                if ($("#jarviswidget-fullscreen-mode").length) {
                    ...
                    var h = $("#jarviswidget-fullscreen-mode").find(self.o.widgets).children("header").children("h2"); //hhh
                    var article = $("#jarviswidget-fullscreen-mode").find(self.o.widgets).children("header").children("h2").parent().parent().parent();
                    var anchoxCantWidget = "";
            ...
            self.widget.on(clickEvent, ".jarviswidget-fullscreen-btn", function (e) {
                ...
                if ($("#jarviswidget-fullscreen-mode").length) {
                    ...
                    var h = thisWidget.children("header").children("h2"); //hhh2
                    var article = h.parent().parent().parent().parent();
                    var anchoxCantWidget = "";
            ...
            self.widget.on(clickEvent, ".jarviswidget-edit-btn btn-" + secundaryColor, function (e) {
            ...
            self.widget.on(clickEvent, ".jarviswidget-delete-btn", function (e) {
                ...
                $.SmartMessageBox({
                    title: "<i class='fa fa-times' style='color:#ed1c24'></i> &iquest;Delete Widget de: " + '' + widTitle + '?',
                    content: "",
                    buttons: "[No][Si]"
    ...
    $.fn[pluginName].defaults = {
        ...
        customEnd: function () { },
        buttonOrder: "%refresh% %delete% %custom% %fullscreen% %toggle%",
        opacity: 1,
        dragHandle: "> header",
