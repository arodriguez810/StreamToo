...
{
    public partial class RDEvent : IScopeble
    {
        ...
        {
        Helper.Audit(db, "RDEvent", AuditMode.Edit, id,this);
            List<string> messages = new List<string>();
            return ScopeHelper.RegulateMessages(messages);
        }
        public BoolString AfterCreate(Context db)
        {
        Helper.Audit(db, "RDEvent", AuditMode.Create, id,this);
            List<string> messages = new List<string>();
            return ScopeHelper.RegulateMessages(messages);
        }
        public BoolString AfterDelete(Context db)
        {
        Helper.Audit(db, "RDEvent", AuditMode.Delete, id,this);
            List<string> messages = new List<string>();
            return ScopeHelper.RegulateMessages(messages);
        }
        public BoolString AfterActive(Context db)
        {
        Helper.Audit(db, "RDEvent", AuditMode.Active, id,this);
            List<string> messages = new List<string>();
            return ScopeHelper.RegulateMessages(messages);
        }
        public BoolString AfterInactive(Context db)
        {
        Helper.Audit(db, "RDEvent", AuditMode.Inactive, id,this);
            List<string> messages = new List<string>();
            return ScopeHelper.RegulateMessages(messages);
        }
    }
