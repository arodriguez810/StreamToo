...
{
    public partial class BaseColumn : IScopeble
    {
        ...
        {
        Helper.Audit(db, "BaseColumn", AuditMode.Edit, id,this);
            List<string> messages = new List<string>();
            return ScopeHelper.RegulateMessages(messages);
        }
        public BoolString AfterCreate(Context db)
        {
        Helper.Audit(db, "BaseColumn", AuditMode.Create, id,this);
            List<string> messages = new List<string>();
            return ScopeHelper.RegulateMessages(messages);
        }
        public BoolString AfterDelete(Context db)
        {
        Helper.Audit(db, "BaseColumn", AuditMode.Delete, id,this);
            List<string> messages = new List<string>();
            return ScopeHelper.RegulateMessages(messages);
        }
        ...
        {
        Helper.Audit(db, "BaseColumn", AuditMode.Inactive, id,this);
            List<string> messages = new List<string>();
            return ScopeHelper.RegulateMessages(messages);
        }
    }
