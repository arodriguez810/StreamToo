...
{
    public partial class BaseUser : IScopeble
    {
        ...
        public BoolString Approve(Context db, bool validate = true)
        {
            List<string> messages = new List<string>();
            return ScopeHelper.RegulateMessages(messages);
        }

        public BoolString Decline(Context db)
        {
            List<string> messages = new List<string>();
            return ScopeHelper.RegulateMessages(messages);
        }
        ...
        public BoolString Decline(Context db, bool validate = true)
        {
            List<string> messages = new List<string>();
            return ScopeHelper.RegulateMessages(messages);
        }
