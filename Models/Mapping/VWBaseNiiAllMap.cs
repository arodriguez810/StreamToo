...
{
    public class VWBaseNiiAllMap : EntityTypeConfiguration<VWBaseNiiAll>
    {
        public VWBaseNiiAllMap()
        {
            // Primary Key
            ...
            this.Property(t => t.alterText)
                .HasMaxLength(128);

            // Table & Column Mappings
            this.ToTable("VWBaseNiiAll");
            ...
            this.Property(t => t.alterText).HasColumnName("alterText");
        }
    }
}
