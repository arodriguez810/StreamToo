...
(function ($) {
    $.SmartMessageBox = function (settings, callback) {
        ...
        if (isIE8orlower() == 0) {
            ...
            //audioElement.setAttribute("src", $.sound_path + "messagebox.mp3123");
            //$.get();
        ...
        Content = "<div class='modal fade in newContainer' id='{0}' tabindex='-1' role='dialog' aria-labelledby='myModalLabel' aria-hidden='false' style='display: block;'>".format(SmartMSGboxCount);
        Content += "    <div class='modal-dialog' style=''>";
        Content += "        <div class='modal-content'>";
        Content += "            <div class='modal-body no-padding' id='baseDynamicModalBody'>";
        Content += "                <div class='panel panel-primary'>";
        Content += "                      <div class='panel-heading'>";
        Content += "                        <h3 class='panel-title'>" + settings.title + "</h3>";
        Content += "                      </div>";
        Content += "                      <div class='panel-body'>";
        Content += "                      <p style='text-align: center;padding-top: 20px;font-size: larger;font-weight: bold;'>" + settings.content + "</p>";

        Content += InputType;
        Content += "<p class='newContainerButton' style='text-align: center;'>";
        ...
        for (var i = settings.buttons.length - 1; i >= 0; i--) {
            if (settings.buttons[i] == "]") {
                Name = ""
            } else {
                if (settings.buttons[i] == "[") {
                    NumBottons++;
                    Name = "<button style='margin-right: 20px;' id='bot" + NumBottons + "-Msg" + SmartMSGboxCount + "' class='btn {1} btn-sm botTempo'>{0}</button>".format(Name.split('').reverse().join(''), Name.toLowerCase() == "on" ? "btn-danger" : "btn-info");
                    Content += Name
                } else {
        ...
        if (SmartMSGboxCount > 1) {
            $(".newContainer").hide();
            $(".newContainer").css("z-index", 99999)
        }
    ...
    $.bigBox = function (settings, callback) {
        ...
        if (settings.sound === true) {
            if (isIE8orlower() == 0) {
                ...
                //    audioElement.setAttribute("src", $.sound_path + "bigbox.oggasd")
                //} else {
                //    audioElement.setAttribute("src", $.sound_path + "bigbox.mp3asd")
                //}
                //$.get();
                //audioElement.addEventListener("load", function () {
                //    audioElement.play()
